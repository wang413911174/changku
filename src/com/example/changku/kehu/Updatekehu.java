...
public class Updatekehu extends Activity {
	/**
	 * 公司名称
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String selectStr = "select * from customers where _id='" + kid + "';";
		...
		if (companyName.trim().equals("") || companyName == null) {
			...
			do {
				if (count > 0) {
					...
					if (companyName.equals(str1) && dutyPerson.equals(str2)
						...
						DialogDemo.buidler(Updatekehu.this, "错误信息", "该客户已经存在");
						mCursor.close();
						break;
					}
				}
			...
			if (!(companyName.equals(str1) && dutyPerson.equals(str2)
					...
					&& telephone.equals(str7) && fax.equals(str8) && homePageUrl
						.equals(str9))) {
				String updataStr ="update customers set companyName='" + companyName + "',dutyPerson='" + dutyPerson + "',companyAddress='"
				...
				// 添加成功打印toast
				Toast.makeText(Updatekehu.this, "修改客户成功", Toast.LENGTH_SHORT)
						.show();
				Updatekehu.this.finish();
			}
		}
	}
