...
public class Addgongyingshang extends Activity {
		/**
		 * 公司名称
		 */
		...
		public void doSubmit(View v) {
			...
			if (companyName.trim().equals("") || companyName == null) {
				...
				String customerStr = "select * from supplier;";
				...
				do {
					if (count > 0) {
						...
						if (companyName.equals(str1) && dutyPerson.equals(str2)
							...
							DialogDemo.buidler(Addgongyingshang.this, "错误信息", "该供应商已经存在");
							mCursor.close();
							break;
						}
					}
				...
				if (!(companyName.equals(str1) && dutyPerson.equals(str2)
					...
					// 获取即将插入的数据的id
					int id = 0;
					String customerid = "select max(_id) from supplier;";
					...
					// 插入语句
					String insertStr = "insert into supplier values('" + id
					...
					// 添加成功打印toast
					Toast.makeText(Addgongyingshang.this, "添加成功", Toast.LENGTH_SHORT).show();
					mCursorid.close();
				}
			}
		}
